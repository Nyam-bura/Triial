...
class CustomerComplaintsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['reporting_date','complaint_code','frequency','complainant_name','complainant_age','complainant_contact_number','location','education_level','extra_details',
              'date_of_occurence','date_resolved','status','amount','currency','psp_customer_info_id']
...
class MobileInformationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['favorite_cell','sub_county_code','agent_type_code','psp_customer_info_id','agent_status','band_code','cash_in_volume','value_cash_in','cash_out_volume',
...
class ScheduledDirectorsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['directors_name','type_of_director','date_of_birth','identification_documents','level_of_education','directorship_position',
