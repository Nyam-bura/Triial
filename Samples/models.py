...
class MobileInformation(models.Model):
    ...
    psp_customer_info_id = models.CharField(_("psp_customer_info_id"),max_length=255,blank=False,null=True)
...
class CustomerComplaints(models.Model):
    ...
    psp_customer_info_id = models.ForeignKey(MobileInformation,on_delete=models.CASCADE,null=True,related_name='mobile')
